...
const Main = () => {
    const { onSent, showResult, recentPrompt, setShowResult, loading, resultData, setInput, input } = useContext(Context); // Fix: added setShowResult
    
    console.log("ShowResult:", showResult); // Debugging ke liye
